...
La cuantización es el paso de JPEG que introduce pérdidas.
...
$Q$ es una matriz fija multiplicada por una constante de cuantización $q$:
...
\includegraphics[width=3cm]{images/lenaColor.png} 
$\to$
\includegraphics[width=3cm]{images/lenaY_comp.png} 
$+$
\includegraphics[width=3cm]{images/lenaCbCr_comp.png}
$\to$
\includegraphics[width=3cm]{images/lena_comp.png}
}
